...
abstract class $SignInStateCopyWith<$Res> {
  ...
  $Res call({String username, String password, bool submitting});
}
...
class _$_SignInState implements _SignInState {
  const _$_SignInState(
      {this.username = '', this.password = '', this.submitting = false});
  ...
  @override
  String toString() {
    return 'SignInState(username: $username, password: $password, submitting: $submitting)';
  }
...
abstract class _SignInState implements SignInState {
  const factory _SignInState(
      {final String username,
      final String password,
      final bool submitting}) = _$_SignInState;

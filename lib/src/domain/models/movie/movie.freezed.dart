...
class _$_ProductionCompany implements _ProductionCompany {
  ...
  @override
  String toString() {
    return 'ProductionCompany(id: $id, logoPath: $logoPath, name: $name)';
  }
...
abstract class _ProductionCompany implements ProductionCompany {
  const factory _ProductionCompany(
      ...
      required final String name}) = _$_ProductionCompany;
...
abstract class $ProductionCountryCopyWith<$Res> {
  ...
  $Res call({@JsonKey(name: 'iso_639_1') String? iso31661, String name});
}
...
class __$$_ProductionCountryCopyWithImpl<$Res>
  ...
  __$$_ProductionCountryCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_ProductionCountry));

  @override
  _$_ProductionCountry get _value => super._value as _$_ProductionCountry;
...
class _$_ProductionCountry implements _ProductionCountry {
  const _$_ProductionCountry(
      {@JsonKey(name: 'iso_639_1') required this.iso31661, required this.name});
...
abstract class _ProductionCountry implements ProductionCountry {
  const factory _ProductionCountry(
      {@JsonKey(name: 'iso_639_1') required final String? iso31661,
